...
原文链接: [https://www.ibm.com/developerworks/cn/java/j-master-spring-transactional-use/](https://www.ibm.com/developerworks/cn/java/j-master-spring-transactional-use/)
...
### 3.3 @Transactional 只能应用到 public 方法才有效
