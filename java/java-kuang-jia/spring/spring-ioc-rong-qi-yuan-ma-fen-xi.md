...
原文链接: [https://javadoop.com/post/spring-ioc](https://javadoop.com/post/spring-ioc)
...
#### 3.2.3 加载 Bean: loadBeanDefinitions
...
**3.2.3.1 doRegisterBeanDefinitions**
...
**3.2.3.2 processBeanDefinition 解析 bean 标签**
...
### 3.4 准备 Bean 容器: prepareBeanFactory
...
#### 3.5.1 preInstantiateSingletons
