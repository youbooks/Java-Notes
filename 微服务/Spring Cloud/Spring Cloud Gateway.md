...
> 转载：[SpringCloud gateway （史上最全）](https://www.cnblogs.com/crazymakercircle/p/11704077.html)
...
![2021-03-10-gqss4q](https://image.ldbmcs.com/2021-03-10-gqss4q.jpg)
...
![2021-03-10-9hYH9n](https://image.ldbmcs.com/2021-03-10-9hYH9n.jpg)

所以Spring Cloud Zuul 是基于servlet之上的一个阻塞式处理模型，即Spring实现了处理所有request请求的一个servlet（DispatcherServlet），并由该servlet阻塞式处理处理。所以Spring Cloud Zuul无法摆脱servlet模型的弊端。虽然Zuul 2.0开始，使用了Netty，并且已经有了大规模Zuul 2.0集群部署的成熟案例，但是，Spring Cloud官方已经没有集成改版本的计划了。
...
![2021-03-10-S4m2FF](https://image.ldbmcs.com/2021-03-10-S4m2FF.jpg)
...
![2021-03-10-WGCA2Q](https://image.ldbmcs.com/2021-03-10-WGCA2Q.jpg)
...
![2021-03-10-69aTzp](https://image.ldbmcs.com/2021-03-10-69aTzp.jpg)

Gateway的主要功能之一是**转发请求**，转发规则的定义主要包含三个部分：
...
![2021-03-10-8fMkiC](https://image.ldbmcs.com/2021-03-10-8fMkiC.jpg)

说白了 Predicate 就是为了实现一组匹配规则，方便让请求过来找到对应的 Route 进行处理，接下来我们接下 Spring Cloud GateWay 内置几种 Predicate 的使用。

#### 3.1.1 转发规则（predicates）

假设转发uri都设定为***[http://localhost:9023](http://localhost:9023/)***
...
![2021-03-10-gAk0qF](https://image.ldbmcs.com/2021-03-10-gAk0qF.jpg)
...
![2021-03-10-kKYmiB](https://image.ldbmcs.com/2021-03-10-kKYmiB.jpg)
...
![2021-03-10-GrSs5Q](https://image.ldbmcs.com/2021-03-10-GrSs5Q.jpg)
...
![2021-03-10-4qmbdo](https://image.ldbmcs.com/2021-03-10-4qmbdo.jpg)
...
![2021-03-10-mEQV16](https://image.ldbmcs.com/2021-03-10-mEQV16.jpg)
