...
> 转载：[阿里技术专家详解 DDD 系列 第一讲- Domain Primitive](https://zhuanlan.zhihu.com/p/340911587)
...
![2021-05-30-mfmdqr](https://image.ldbmcs.com/2021-05-30-mfmdqr.jpg)
...
![2021-05-30-0SvZYB](https://image.ldbmcs.com/2021-05-30-0SvZYB.jpg)
...
![2021-05-30-WBA4IH](https://image.ldbmcs.com/2021-05-30-WBA4IH.jpg)
...
### 7.2 使用 Domain Primitive 的三原则

- 让隐性的概念显性化。
- 让隐性的上下文显性化。
- 封装多对象行为。

### 7.3 Domain Primitive 和 DDD 里 Value Object 的区别
...
### 7.4 Domain Primitive 和 Data Transfer Object (DTO) 的区别

在日常开发中经常会碰到的另一个数据结构是 DTO ，比如方法的入参和出参。DP 和 DTO 的区别如下：

![2021-05-30-H9btF3](https://image.ldbmcs.com/2021-05-30-H9btF3.jpg)

### 7.5 什么情况下应该用 Domain Primitive
...
### 8.1 第一步 - 创建 Domain Primitive，收集所有 DP 行为
