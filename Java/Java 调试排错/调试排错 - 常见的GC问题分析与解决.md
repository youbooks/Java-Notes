...
> 原文链接：[Java中9种常见的CMS GC问题分析与解决](https://tech.meituan.com/2020/11/12/java-9-cms-gc.html)
...
自 Sun 发布 Java 语言以来，开始使用 GC 技术来进行内存自动管理，避免了手动管理带来的悬挂指针（Dangling Pointer）问题，很大程度上提升了开发效率，从此 GC 技术也一举成名。GC 有着非常悠久的历史，1960 年有着“Lisp 之父”和“人工智能之父”之称的 John McCarthy 就在论文中发布了 GC 算法，60 年以来， GC 技术的发展也突飞猛进，但**不管是多么前沿的收集器也都是基于三种基本算法的组合或应用**，也就是说 GC 要解决的根本问题这么多年一直都没有变过。笔者认为，在不太远的将来， GC 技术依然不会过时，比起日新月异的新技术，GC 这门古典技术更值得我们学习。
...
![2021-01-27-8WLe5p](https://image.ldbmcs.com/2021-01-27-8WLe5p.jpg)
...
![2021-01-27-lTLXHC](https://image.ldbmcs.com/2021-01-27-lTLXHC.jpg)
...
![2021-01-27-e43Kth](https://image.ldbmcs.com/2021-01-27-e43Kth.jpg)

把 mark、sweep、compaction、copying 这几种动作的耗时放在一起看，大致有这样的关系：

![2021-01-27-B3QiXx](https://image.ldbmcs.com/2021-01-27-B3QiXx.jpg)
...
![2021-01-27-nWK8k4](https://image.ldbmcs.com/2021-01-27-nWK8k4.jpg)
...
![2021-01-27-JktfQe](https://image.ldbmcs.com/2021-01-27-JktfQe.jpg)

#### 2.5.3 常用收集器

目前使用最多的是 CMS 和 G1 收集器，二者都有分代的概念，主要内存结构如下：

![2021-01-27-GS3hMj](https://image.ldbmcs.com/2021-01-27-GS3hMj.jpg)
...
![2021-01-27-Eql6JD](https://image.ldbmcs.com/2021-01-27-Eql6JD.jpg)
...
![2021-01-27-aRnzDO](https://image.ldbmcs.com/2021-01-27-aRnzDO.jpg)
...
![2021-01-27-STerPQ](https://image.ldbmcs.com/2021-01-27-STerPQ.jpg)
...
![2021-01-27-zRtDfv](https://image.ldbmcs.com/2021-01-27-zRtDfv.jpg)
...
![2021-01-27-FkML4Z](https://image.ldbmcs.com/2021-01-27-FkML4Z.jpg)
...
![2021-01-27-0J09QZ](https://image.ldbmcs.com/2021-01-27-0J09QZ.jpg)
...
![2021-01-27-9rMKUl](https://image.ldbmcs.com/2021-01-27-9rMKUl.jpg)
...
![2021-01-27-N7nVbw](https://image.ldbmcs.com/2021-01-27-N7nVbw.jpg)

![2021-01-27-hpMjeO](https://image.ldbmcs.com/2021-01-27-hpMjeO.jpg)
...
![2021-01-27-X6mgiT](https://image.ldbmcs.com/2021-01-27-X6mgiT.jpg)

![2021-01-27-Nmy1sM](https://image.ldbmcs.com/2021-01-27-Nmy1sM.jpg)
...
![2021-01-27-eTUudK](https://image.ldbmcs.com/2021-01-27-eTUudK.jpg)
...
![2021-01-27-u01lnq](https://image.ldbmcs.com/2021-01-27-u01lnq.jpg)
...
![2021-01-27-wYN9ef](https://image.ldbmcs.com/2021-01-27-wYN9ef.jpg)
...
- CMS Init Mark执行步骤，实现在 `CMSCollector::checkpointRootsInitialWork()` 和 `CMSParInitialMarkTask::work` 中，整体步骤和代码如下：
  ...
  ![2021-01-27-f9vNNM](https://image.ldbmcs.com/2021-01-27-f9vNNM.jpg)
...
- CMS Final Remark 执行步骤，实现在 `CMSCollector::checkpointRootsFinalWork()` 中，整体代码和步骤如下：
  ...
  ![2021-01-27-j3nEkk](https://image.ldbmcs.com/2021-01-27-j3nEkk.jpg)
...
![2021-01-27-jbwClY](https://image.ldbmcs.com/2021-01-27-jbwClY.jpg)
...
![2021-01-27-zyz1UX](https://image.ldbmcs.com/2021-01-27-zyz1UX.jpg)
...
![2021-01-27-75mkwt](https://image.ldbmcs.com/2021-01-27-75mkwt.jpg)

最终定位到是，项目中对 `GIPInputStream` 的使用错误，没有正确的 close()。

![2021-01-27-yaDjIC](https://image.ldbmcs.com/2021-01-27-yaDjIC.jpg)
...
![2021-01-27-df6Hdn](https://image.ldbmcs.com/2021-01-27-df6Hdn.jpg)
...
![2021-01-27-XQUDGI](https://image.ldbmcs.com/2021-01-27-XQUDGI.jpg)
...
![2021-01-27-w4WC3y](https://image.ldbmcs.com/2021-01-27-w4WC3y.jpg)
...
![2021-01-27-WshOtz](https://image.ldbmcs.com/2021-01-27-WshOtz.jpg)
...
![2021-01-27-abymu6](https://image.ldbmcs.com/2021-01-27-abymu6.jpg)
...
- **GC 参数：** 如果堆、栈确实无法第一时间保留，一定要保留 GC 日志，这样我们最起码可以看到 GC Cause，有一个大概的排查方向。关于 GC 日志相关参数，最基本的 `-XX:+HeapDumpOnOutOfMemoryError` 等一些参数就不再提了，笔者建议添加以下参数，可以提高我们分析问题的效率。
  ...
  ![2021-01-27-dOMama](https://image.ldbmcs.com/2021-01-27-dOMama.jpg)
