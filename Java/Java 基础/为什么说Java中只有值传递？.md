...
> 转载：[为什么说Java中只有值传递](https://blog.csdn.net/bjweimengshu/article/details/79799485)
...
![2021-03-21-LaNFvU](https://image.ldbmcs.com/2021-03-21-LaNFvU.jpg)
...
![2021-03-21-GceTle](https://image.ldbmcs.com/2021-03-21-GceTle.jpg)
...
![2021-03-21-by6vAn](https://image.ldbmcs.com/2021-03-21-by6vAn.jpg)同样的，在参数传递的过程中，实际参数的地址`0X1213456`被拷贝给了形参，只是，在这个方法中，并没有对形参本身进行修改，而是修改的形参持有的地址中存储的内容。
...
那么，既然这样，为啥上面同样是传递对象，传递的String对象和User对象的表现结果不一样呢？我们在pass方法中使用`name = "hollischuang";`试着去更改name的值，阴差阳错的直接改变了name的引用的地址。因为这段代码，会new一个String，再把引用交给name，即等价于：
...
![2021-03-21-sfijZ3](https://image.ldbmcs.com/2021-03-21-sfijZ3.jpg)
