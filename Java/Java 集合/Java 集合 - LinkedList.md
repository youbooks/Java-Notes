...
![2021-03-02-EeRthz](https://image.ldbmcs.com/2021-03-02-EeRthz.jpg)
...
### 2.4 removeFirest(), removeLast(), remove(e), remove(index)

`remove()`方法也有两个版本，一个是删除跟指定元素相等的第一个元素`remove(Object o)`，另一个是删除指定下标处的元素`remove(int index)`。

![2021-03-02-B4WsC0](https://image.ldbmcs.com/2021-03-02-B4WsC0.jpg)
...
![2021-03-02-4BCqWn](https://image.ldbmcs.com/2021-03-02-4BCqWn.jpg)
