...
- `同步IO` 和 `非同步IO`
  ...
  这两个概念是`操作系统级别`的。主要描述的是操作系统在收到程序请求IO操作后，如果IO资源没有准备好，该如何相应程序的问题: 前者不响应，直到IO资源准备好以后；后者返回一个标记(好让程序和自己知道以后的数据往哪里通知)，当IO资源准备好以后，再用事件机制返回给程序
...
![2021-02-24-GZISfm](https://image.ldbmcs.com/2021-02-24-GZISfm.jpg)
...
![2021-02-24-rMHo8C](https://image.ldbmcs.com/2021-02-24-rMHo8C.jpg)
...
![2021-02-24-4MCSPr](https://image.ldbmcs.com/2021-02-24-4MCSPr.jpg)
...
- 服务器线程发起一个accept动作，询问操作系统 是否有新的socket套接字信息从端口X发送过来。
  ...
  ![2021-02-24-fIDwS3](https://image.ldbmcs.com/2021-02-24-fIDwS3.jpg)

- 注意，是询问操作系统。也就是说socket套接字的IO模式支持是基于操作系统的，那么自然同步IO/异步IO的支持就是需要操作系统级别的了。如下图:

  ![2021-02-24-sYpNIh](https://image.ldbmcs.com/2021-02-24-sYpNIh.jpg)

  ![2021-02-24-wkGNxk](https://image.ldbmcs.com/2021-02-24-wkGNxk.jpg)
