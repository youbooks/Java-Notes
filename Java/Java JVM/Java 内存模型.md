...
![2021-01-28-nLhlB2](https://image.ldbmcs.com/2021-01-28-nLhlB2.jpg)
...
![2021-01-28-kP411W](https://image.ldbmcs.com/2021-01-28-kP411W.jpg)
...
![2021-01-28-eejxZc](https://image.ldbmcs.com/2021-01-28-eejxZc.jpg)
...
![2021-01-28-WdVZ1W](https://image.ldbmcs.com/2021-01-28-WdVZ1W.jpg)
...
![2021-01-28-Hfqzxq](https://image.ldbmcs.com/2021-01-28-Hfqzxq.jpg)
...
![2021-01-28-KGsKGq](https://image.ldbmcs.com/2021-01-28-KGsKGq.jpg)

要解决此问题，您可以使用Java的volatile关键字。 volatile关键字可以确保直接从主内存读取给定变量，并在更新时始终写回主内存。

#### 1.2.4 JMM与硬件内存连接 - 竞态条件
...
![2021-01-28-5U0zJH](https://image.ldbmcs.com/2021-01-28-5U0zJH.jpg)
...
![2021-01-28-XamYgF](https://image.ldbmcs.com/2021-01-28-XamYgF.jpg)
...
![2021-01-28-mjAIVN](https://image.ldbmcs.com/2021-01-28-mjAIVN.jpg)
...
![2021-01-28-GV6qSE](https://image.ldbmcs.com/2021-01-28-GV6qSE.jpg)
...
![2021-01-28-uLc6XJ](https://image.ldbmcs.com/2021-01-28-uLc6XJ.jpg)
...
![2021-01-28-ODptf2](https://image.ldbmcs.com/2021-01-28-ODptf2.jpg)
...
![2021-01-28-u6t2oX](https://image.ldbmcs.com/2021-01-28-u6t2oX.jpg)

如上图所示，A 和 C 之间存在数据依赖关系，同时 B 和 C 之间也存在数据依赖关系。因此在最终执行的指令序列中，C 不能被重排序到 A 和 B 的前面（C 排到 A 和 B 的前面，程序的结果将会被改变）。但 A 和 B 之间没有数据依赖关系，编译器和处理器可以重排序 A 和 B 之间的执行顺序。下图是该程序的两种执行顺序：

![2021-01-28-4zGZi7](https://image.ldbmcs.com/2021-01-28-4zGZi7.jpg)
...
![2021-01-28-ePLJxK](https://image.ldbmcs.com/2021-01-28-ePLJxK.jpg)
...
![2021-01-28-CUNxjz](https://image.ldbmcs.com/2021-01-28-CUNxjz.jpg)
...
![2021-01-28-nhmYpW](https://image.ldbmcs.com/2021-01-28-nhmYpW.jpg)
...
![2021-01-28-Y6tnF5](https://image.ldbmcs.com/2021-01-28-Y6tnF5.jpg)

现在我们再假设这两个线程没有做同步，下面是这个未同步程序在顺序一致性模型中的执行示意图：

![2021-01-28-2A4saO](https://image.ldbmcs.com/2021-01-28-2A4saO.jpg)
...
![2021-01-28-XW3w8X](https://image.ldbmcs.com/2021-01-28-XW3w8X.jpg)
...
![2021-01-28-83CjVE](https://image.ldbmcs.com/2021-01-28-83CjVE.jpg)
...
![2021-01-28-Uh7nDL](https://image.ldbmcs.com/2021-01-28-Uh7nDL.jpg)
...
![2021-01-28-Uxh2fZ](https://image.ldbmcs.com/2021-01-28-Uxh2fZ.jpg)

如上图所示，JMM 屏蔽了不同处理器内存模型的差异，它在不同的处理器平台之上为 java 程序员呈现了一个一致的内存模型。

#### 2.4.2 JMM，处理器内存模型与顺序一致性内存模型之间的关系

JMM 是一个语言级的内存模型，处理器内存模型是硬件级的内存模型，顺序一致性内存模型是一个理论参考模型。下面是语言内存模型，处理器内存模型和顺序一致性内存模型的强弱对比示意图：

![2021-01-28-2pxese](https://image.ldbmcs.com/2021-01-28-2pxese.jpg)
...
![2021-01-28-msQrm2](https://image.ldbmcs.com/2021-01-28-msQrm2.jpg)
...
![2021-01-28-Vz2N0v](https://image.ldbmcs.com/2021-01-28-Vz2N0v.jpg)

只要多线程程序是正确同步的，JMM 保证该程序在任意的处理器平台上的执行结果，与该程序在顺序一致性内存模型中的执行结果一致。

#### 2.4.5 JSR-133 对旧内存模型的修补
