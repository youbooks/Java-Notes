...
> 转载：[SpringBoot的启动流程是怎样的？SpringBoot源码（七）](https://segmentfault.com/a/1190000022119546)
...
温故而知新，我们来简单回顾一下上篇的内容，上一篇我们分析了SpringBoot**SpringBoot内置的各种Starter是怎样构建的?**，现将关键点重新回顾总结下：
