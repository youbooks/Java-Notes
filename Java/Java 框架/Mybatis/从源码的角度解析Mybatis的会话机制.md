> 转载：[从源码的角度解析Mybatis的会话机制](http://objcoding.com/2019/03/20/mybatis-sqlsession/)
...
![2020-09-10-iloL9G](https://image.ldbmcs.com/2020-09-10-iloL9G.jpg)

从日志可以看出，在没有加事务的情况下，确实是Mapper的每次请求数据库，都会创建一个SqlSession与数据库交互，下面我们再看看加了事务的情况：

![2020-09-10-Jc7O9g](https://image.ldbmcs.com/2020-09-10-Jc7O9g.jpg)
