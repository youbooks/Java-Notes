...
![2021-02-21-SU95Ce](https://image.ldbmcs.com/2021-02-21-SU95Ce.jpg)
...
> [RFC2581](https://tools.ietf.org/html/rfc2581#page-6) 中提出的快速重传就会缓解上述问题，当接收方收到乱序的数据段时，会立刻发送三个连续的 ACK 触发发送方的重传。
