...
原文链接: [https://www.jianshu.com/p/116fc2d08165](https://www.jianshu.com/p/116fc2d08165)

## 1. Nginx安装注意事项

安装的时候需要注意加上 **--with-http\_ssl\_module**，因为http\_ssl\_module不属于Nginx的基本模块。
